...
function GraalHelper:addFearPanel(self)
    ...
    _G[self.options.fearLockCheck:GetName() .. "Text"]:SetTextColor(1, 0.90, 0.20)
    ...
    _G[self.options.fearNameCheck:GetName() .. "Text"]:SetTextColor(1, 0.90, 0.20)
    ...
    self.options.fearSoundCheck = CreateFrame("CheckButton", "GraalHelperFearSoundCheck",
        self.options.panels.fear,
        "InterfaceOptionsCheckButtonTemplate")
    self.options.fearSoundCheck:SetPoint("TOPLEFT", self.options.fearNameCheck, "BOTTOMLEFT", 0, -8)
    _G[self.options.fearSoundCheck:GetName() .. "Text"]:SetTextColor(1, 0.90, 0.20)
    ...
    self.options.fearSoundLabel:SetPoint("TOPLEFT", 18, -320)
    ...
    _G[self.options.fearLockCheck:GetName() .. "Text"]:SetText(L.lockWindow)
    _G[self.options.fearNameCheck:GetName() .. "Text"]:SetText(L.showBuffNames)
    _G[self.options.fearSoundCheck:GetName() .. "Text"]:SetText(L.enableSound)
