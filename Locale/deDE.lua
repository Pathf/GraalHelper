...
GraalHelper.L = {
    ...
    stunFound = "Betäubungseffekt aktiv",
    stunLine = "Zauber können nicht gewirkt werden - Betäubung aktiv!",
    stunSection = "Betäubungseffekt",
    stunTitle = "Betäubungseffekt!",
    rootFound = "Bewegungsunfähigkeit aktiv",
    rootLine = "Zauber können nicht gewirkt werden - Bewegungsunfähigkeit aktiv!",
    rootSection = "Bewegungsunfähigkeit",
    rootTitle = "Bewegungsunfähigkeit!",
    disarmFound = "Entwaffnungseffekt aktiv",
    disarmLine = "Zauber können nicht gewirkt werden - Entwaffnung aktiv!",
    disarmSection = "Entwaffnungseffekt",
    disarmTitle = "Entwaffnungseffekt!",
    fearFound = "Furchteffekt aktiv",
